      ...
      <div className="space-y-4">
        <div className="bg-teal-50 rounded-2xl p-4">
          ...
          <ul className="text-sm text-gray-700 space-y-1.5">
            <li>• Пройдите осмотр у гинеколога для оценки здоровья</li>
            <li>• Сдайте базовые анализы крови и на гормоны</li>
            <li>• Начните принимать фолиевую кислоту заблаговременно</li>
            <li>• Пересмотрите питание и режим сна</li>
    ...
    content: (
      <div className="space-y-4">
        <p className="text-gray-700 text-sm leading-relaxed">
          Запишитесь к акушеру-гинекологу прямо сейчас через официальный чат-бот Свердловской области — быстро и без очередей.
        </p>
        <a
          href="https://max.ru"
          target="_blank"
