  ...
  return (
    <div className="border border-amber-200 rounded-xl overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-3 bg-amber-100/60 hover:bg-amber-100 transition-colors text-left"
      >
        <span className="text-xs font-semibold text-amber-800">{title}</span>
        <motion.div animate={{ rotate: open ? 180 : 0 }} transition={{ duration: 0.25 }}>
          <Icon name="ChevronDown" size={14} className="text-amber-600 flex-shrink-0" />
        </motion.div>
      </button>
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <div className="px-4 py-3 text-xs text-gray-700 leading-relaxed bg-white">
              {children}
            </div>
          </motion.div>
        )}
      ...
      <div className="space-y-3">
        ...
        <div className="bg-amber-50 rounded-2xl p-4 space-y-3">
          ...
          <div className="space-y-2">
            <AccordionItem title="🏥 Учреждения МКББ">
            ...
            <AccordionItem title="ℹ️ Критерии бесплодия">
              <p>Пару считают бесплодной, если беременность у женщины не наступает в течение года регулярной половой жизни без использования средств и методов контрацепции. На лечение бесплодия имеют право мужчина и женщина, как состоящие, так и не состоящие в зарегистрированном браке.</p>
            </AccordionItem>
            <AccordionItem title="👩 Обследование женщины">
              ...
              <p>При наличии показаний для хирургического лечения (трубно-перитонеальное бесплодие, миома матки, полипы эндометрия, эндометриоз и т.д.) женщина госпитализируется в гинекологическое отделение для проведения лечения, преимущественно эндоскопического.</p>
            </AccordionItem>
            <AccordionItem title="👨 Обследование мужчины">
              <ul className="space-y-1 mb-2">
              ...
              <p>При наличии показаний для оперативного лечения (варикоцеле, фимоз, гидроцеле) — госпитализация в урологическое отделение.</p>
            </AccordionItem>
            <AccordionItem title="💊 Выбор тактики лечения">
              <p>Выбор тактики ведения и лечения определяется видом бесплодия. При абсолютном трубном бесплодии, неэффективности консервативного и оперативного лечения определяются показания для ВРТ.</p>
            </AccordionItem>
          </div>
        </div>
      </div>
